...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.get_folder_split_csv_x_y.setText(_translate("MainWindow", "Выбрать папку"))
        self.get_folder_button_split_csv_year.setText(_translate("MainWindow", "Выбрать папку"))
        self.get_folder_button_split_csv_weeks.setText(_translate("MainWindow", "Выбрать папку"))
